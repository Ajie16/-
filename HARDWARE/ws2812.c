...
void change(uint8_t (*c)[3], uint8_t index ){
	static int bias1 = 20 ,ca=-4;
	bias1 += ca;
	...
	if( ca==4 )
		ca = -4;
	zero(c);
	c[index+2][0] = 30 + bias1;			//gr9een
	c[index+2][1] = 30 - bias1;		//re
	c[index+2][2] = 30 + bias1;		//blue
	c[index+1][0] = (uint8_t)c[index+2][0]*0.5;			//gr9een
	c[index+1][1] = (uint8_t)c[index+2][1]*0.5;		//re
	c[index+1][2] = (uint8_t)c[index+2][2]*0.5;		//blue
	c[index][0] = (uint8_t)c[index+2][0]*0.2;			//gr9een
	c[index][1] = (uint8_t)c[index+2][1]*0.2;		//re
	c[index][2] = (uint8_t)c[index+2][2]*0.2;		//blue
	if(index==14) {
		c[0][0] = c[index+2][0];			//gr9een
		c[0][1] = c[index+2][1];		//re
		c[0][2] = c[index+2][2];		//blue
	}
	if(index==15) {
		c[0][0] = (uint8_t)c[index+2][0]*0.5;			//gr9een
		c[0][1] = (uint8_t)c[index+2][1]*0.5;		//re
		c[0][2] = (uint8_t)c[index+2][2]*0.5;		//blue
		c[1][0] = (uint8_t)c[index+2][0]*0.2;			//gr9een
		c[1][1] = (uint8_t)c[index+2][1]*0.2;		//re
		c[1][2] = (uint8_t)c[index+2][2]*0.2;		//blue
	}
}
