...
#define GY_SDA_IN()  {GPIOB->CRH&=0XFFFF0FFF;GPIOB->CRH|=8<<12;}
#define GY_SDA_OUT() {GPIOB->CRH&=0XFFFF0FFF;GPIOB->CRH|=3<<12;}

#define GY_IIC_SCL    PBout(10) //SCL
#define GY_IIC_SDA    PBout(11) //SDA	 
#define GY_READ_SDA   PBin(11)  //输入SDA 
